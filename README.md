...
- Use a CSV file of FAQ's as training data. 
- Usually this file is used to assist course learners in case of any questions.
- We will build an LLM based question and answer system that can reduce the workload of human staff.
...
```bash
  https://github.com/VYBHAV97/NLP_QnA_ChatBot.git
```
